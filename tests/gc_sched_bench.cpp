...
BENCHMARK(BM_GcSimulateActionsAutomaticCollect)->Args({1000, 1, 10})->Args({10000, 64, 512})->Args({1000, 1024, 4096})->Args({10000, 64, 1024})->UseRealTime()->Unit(benchmark::kMicrosecond);
