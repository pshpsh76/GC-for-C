...
BENCHMARK(BM_GcSimulateActionsAutomaticCollect)->Args({1000000, 1, 10})->Args({1000000, 64, 512})->Args({50000, 1024, 4096})->Args({100000, 1024, 8196})->UseRealTime()->Unit(benchmark::kMicrosecond);
